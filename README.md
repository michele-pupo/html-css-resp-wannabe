Descrizione:
Usando le CSS media queries, trasforma il repo ‘html-css-resp-wannabe’ in una versione navigabile quando la larghezza dello schermo diventa:
...
Per poter vedere correttamente un sito responsive è necessaria la presenza del tag nella head:
